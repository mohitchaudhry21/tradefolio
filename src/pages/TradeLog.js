...
export default function TradeLog() {
  ...
  // Unique setups and emotions for filter dropdowns — flatten arrays properly
  ...
  const filtered = useMemo(() => {
    ...
    if (search) {
      ...
      arr = arr.filter(t => {
        ...
        const setupMatch = setupStr.toLowerCase().includes(q);
        const notesMatch = t.notes?.toLowerCase().includes(q);
        return symMatch || setupMatch || notesMatch;
      });
    }
            ...
            <div className="modal-body">
              ...
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:8,marginBottom:14}}>
                {[
                  ...
                  ['Setup',(Array.isArray(detailTrade.setup)?detailTrade.setup.join(', '):detailTrade.setup)||'—'],['Timeframe',detailTrade.timeframe||'—'],
